...
[hidden]:where(:not([hidden="until-found"])) {
  ...
  :root {
    /* Midnight Ops - Dark Theme (Default) */
    --bg-primary: #0F1117;
    --bg-secondary: #1A1D26;
    --bg-tertiary: #252A36;
    --border-default: #2E3442;
    --border-focus: #4F5A6E;
    --text-primary: #F4F4F5;
    ...
    --deposit-green-bg: rgba(34, 197, 94, 0.1);
    --withdraw-red: #EF4444;
    --withdraw-red-bg: rgba(239, 68, 68, 0.1);
    --warning-amber: #F59E0B;
    --warning-amber-bg: rgba(245, 158, 11, 0.1);
    --holding-blue: #3B82F6;
    --holding-blue-bg: rgba(59, 130, 246, 0.1);
    --paying-purple: #A855F7;
    --paying-purple-bg: rgba(168, 85, 247, 0.1);
    --platform-teal: #14B8A6;
    --platform-teal-bg: rgba(20, 184, 166, 0.1);
...
.focus-ring:focus {
  ...
  --tw-ring-color: var(--holding-blue);
...
.bg-deposit {
  background-color: var(--deposit-green);
}
.bg-deposit-bg {
  background-color: var(--deposit-green-bg);
}
.bg-holding {
  background-color: var(--holding-blue);
}
.bg-holding-bg {
  background-color: var(--holding-blue-bg);
}
.bg-inactive {
  background-color: var(--inactive-gray);
}
.bg-paying-bg {
  background-color: var(--paying-purple-bg);
}
.bg-platform-bg {
  background-color: var(--platform-teal-bg);
}
.bg-text-muted {
...
.bg-withdraw-bg {
  background-color: var(--withdraw-red-bg);
}
.bg-blue-500\/20 {
...
.text-holding {
  color: var(--holding-blue);
}
.text-paying {
  color: var(--paying-purple);
}
.text-platform {
...
.ring-withdraw {
  --tw-ring-color: var(--withdraw-red);
}
.ring-offset-1 {
...
.hover\:text-withdraw:hover {
  color: var(--withdraw-red);
}

.focus\:border-holding:focus {
  border-color: var(--holding-blue);
}

.focus\:border-withdraw:focus {
  border-color: var(--withdraw-red);
}
...
.focus\:ring-holding:focus {
  --tw-ring-color: var(--holding-blue);
}

.focus\:ring-withdraw:focus {
  --tw-ring-color: var(--withdraw-red);
}
...
.focus\:ring-offset-bg-primary:focus {
  --tw-ring-offset-color: var(--bg-primary);
}
